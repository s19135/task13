...
namespace task13.Migrations
{
    ...
    [Migration("20200619062341_Notes")]
    partial class Notes
    {
            ...
            modelBuilder.Entity("task13.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdOrder = 1,
                            DateAccepted = new DateTime(2020, 6, 19, 8, 23, 41, 605, DateTimeKind.Local).AddTicks(98),
                            DateFinished = new DateTime(2020, 6, 19, 8, 23, 41, 608, DateTimeKind.Local).AddTicks(6458),
                            IdCustomer = 1,
                            IdEmployee = 1,
                            Notes = "fast"
                        },
                        ...
                        {
                            IdOrder = 2,
                            DateAccepted = new DateTime(2020, 6, 19, 8, 23, 41, 608, DateTimeKind.Local).AddTicks(7860),
                            DateFinished = new DateTime(2020, 6, 19, 8, 23, 41, 608, DateTimeKind.Local).AddTicks(7896),
                            IdCustomer = 2,
                            IdEmployee = 1,
                            Notes = "for Gustavus"
                        });
