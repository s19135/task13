    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2020, 6, 19, 6, 40, 12, 319, DateTimeKind.Local).AddTicks(2063), new DateTime(2020, 6, 9, 6, 40, 12, 323, DateTimeKind.Local).AddTicks(4248), 1, 1 });

            migrationBuilder.InsertData(
                table: "Order",
                columns: new[] { "IdOrder", "DateAccepted", "DateFinished", "IdCustomer", "IdEmployee" },
                values: new object[] { 2, new DateTime(2020, 6, 9, 6, 40, 12, 323, DateTimeKind.Local).AddTicks(4835), new DateTime(2020, 6, 9, 6, 40, 12, 323, DateTimeKind.Local).AddTicks(4861), 2, 1 });
